...
snapshots['test_booking_detail_list 1'] = [
    {
        ...
        'locale': 'fi',
        'maas_operator_name': 'name of maas operator 1',
        'route_capacity_sales': '',
        'route_name': '',
        'status': 'RESERVED',
        'ticket_count': 0,
        'ticket_system_name': 'name of ticketing system 1',
        'tickets': [
        ]
    }
]
...
snapshots['test_create_booking_capacity_sales_required_for_outbound_and_inbound[3-direction_ids2-False] 1'] = {
    'departure_ids': [
        'Exactly one outbound departure must be selected for this route.'
    ]
}

snapshots['test_create_booking_capacity_sales_required_for_outbound_and_inbound[3-direction_ids4-False] 1'] = {
    'departure_ids': [
        'Exactly one outbound departure must be selected for this route.'
    ]
}

snapshots['test_create_booking_capacity_sales_required_for_outbound_and_inbound[3-direction_ids5-False] 1'] = {
    'departure_ids': [
        'Exactly one outbound departure must be selected for this route.'
    ]
}

snapshots['test_create_booking_capacity_sales_required_for_outbound_and_inbound[4-direction_ids3-False] 1'] = {
    'departure_ids': [
        'Exactly one inbound departure must be selected for this route.'
    ]
}
...
snapshots['test_fetch_availability request 1 body'] = {
    'departures': [
        {
            'date': '2021-04-28',
            'trip_id': 'source_id of trip 1'
        },
        {
            'date': '2021-04-28',
            'trip_id': 'source_id of trip 2'
        }
    ]
}
...
snapshots['test_fetch_availability request 2 body'] = {
    'departures': [
        {
            'date': '2021-04-29',
            'trip_id': 'source_id of trip 3'
        },
        {
            'date': '2021-04-29',
            'trip_id': 'source_id of trip 4'
        }
    ]
}
...
snapshots['test_ticketing_system_errors[ticketing_api_response0-422-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response1-400-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response10-201-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response10-201-reservation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response11-201-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response11-201-reservation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response12-201-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response12-201-reservation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response13-422-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response13-422-reservation] 1'] = {
    'error': {
        'code': 'MAX_CAPACITY_EXCEEDED',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response14-422-confirmation] 1'] = {
    'error': {
...
snapshots['test_ticketing_system_errors[ticketing_api_response14-422-reservation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response15-422-confirmation] 1'] = {
    'error': {
...
snapshots['test_ticketing_system_errors[ticketing_api_response15-422-reservation] 1'] = {
    'error': {
        'code': 'TICKET_SALES_ENDED',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response16-422-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response16-422-reservation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response2-400-confirmation] 1'] = {
    'error': {
...
snapshots['test_ticketing_system_errors[ticketing_api_response3-422-confirmation] 1'] = {
    'error': {
        'code': 'BOOKING_ALREADY_CONFIRMED',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response4-400-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response5-400-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response6-500-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
...
snapshots['test_ticketing_system_errors[ticketing_api_response9-200-confirmation] 1'] = {
    'error': {
        'code': 'TICKET_SYSTEM_ERROR',
        'details': '',
        'message': ''
